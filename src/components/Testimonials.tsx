...
const fallbackTestimonials: Testimonial[] = [
  ...
  },
  {
    ...
    image: '',
    content: 'A metodologia estruturada e a gestão transparente garantem previsibilidade. Análise técnica detalhada e execução controlada com resultados consistentes.',
    rating: 5,
