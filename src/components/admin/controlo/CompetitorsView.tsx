    ...
    <div>
      ...
      {competitors.length === 0 ? (
        <div style={{ textAlign: 'center', padding: `${spacing[12]} ${spacing[8]}`, color: colors.gray[400] }}>
          ...
          <p style={{ fontSize: typography.fontSize.base, fontWeight: typography.fontWeight.semibold, color: colors.gray[500], marginBottom: spacing[2] }}>Nenhum comparavel registado</p>
          <p style={{ fontSize: typography.fontSize.sm, color: colors.gray[400], margin: 0 }}>Adicione concorrentes para comparar precos e posicionamento.</p>
        </div>
      ) : (
