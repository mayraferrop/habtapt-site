...
import { VelaskNavbar } from './VelaskNavbar';
import { VelaskHero } from './VelaskHero';
import { VelaskProjeto, VelaskInteriores, VelaskPlantas } from './VelaskUnits';
import { VelaskBairro } from './VelaskBairro';
import { VelaskGallery } from './VelaskGallery';
import { VelaskLocation } from './VelaskLocation';
import { VelaskPricing } from './VelaskPricing';
import { VelaskContactForm } from './VelaskContactForm';
import { VelaskFAQ } from './VelaskFAQ';
import { supabaseFetch } from '@/utils/supabase/client';
import { mergeApiUnits, mergeApiPricingRows, type ApiUnit } from '../_data/velask-data';

const ds = designSystem;

export default function VelaskPageClient() {
