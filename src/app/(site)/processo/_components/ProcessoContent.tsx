  ...
  const steps = [
    {
      ...
      details: 'Análise de mercado, zonas em crescimento e oportunidades com alto potencial.',
    ...
    },
    {
      ...
      icon: ClipboardCheck,
      title: 'Avaliação',
      description: 'Due diligence completa e análise financeira.',
    ...
    },
    {
      number: '07',
      icon: DollarSign,
      title: 'Fecho e Reporting',
      description: 'Relatório financeiro e fecho do projeto.',
