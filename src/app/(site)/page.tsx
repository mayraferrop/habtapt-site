...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'habta portugal',
    'habta imóveis',
    'imóveis reabilitados premium',
    'investimento imobiliário portugal',
    'reabilitação urbana portugal',
    'apartamentos premium lisboa',
    'apartamentos premium porto',
    'imóveis cascais premium',
    'moradias reabilitadas portugal',
    'fix and flip lisboa',
    'co-investimento imobiliário portugal',
    'imóveis alto rendimento portugal',
    'gestão património imobiliário',
    'reabilitação inteligente imóveis',
    'decisões imobiliárias baseadas em dados',
  ],
  alternates: {
