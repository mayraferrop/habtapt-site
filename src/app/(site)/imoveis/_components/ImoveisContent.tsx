...
const fallbackProjects: Project[] = [
  {
    ...
    description: 'Três apartamentos a estrear em Campanhã (Porto).',
    landingPage: '/velask',
  ...
  },
  {
    ...
    statusLabel: 'Disponível',
    strategy: 'buy-hold',
    image: 'https://images.unsplash.com/photo-1759150712360-6d48015e4f86?crop=entropy&cs=tinysrgb&fit=crop&fm=avif&ixlib=rb-4.1.0&q=55&w=480',
    roi: '+30%',
    area: '135 m²',
    bedrooms: 3,
    bathrooms: 2,
